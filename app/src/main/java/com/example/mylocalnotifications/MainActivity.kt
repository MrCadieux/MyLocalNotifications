package com.example.mylocalnotifications
...
class MainActivity : AppCompatActivity() {
    ...
    private var channelID = "com.example.mylocalnotifications"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener{
            ...
            if (areNotificationsEnabled(this, channelID)){
                ...
                //the user re-enable notificaations for this application again.
    ...
    fun sendNotification(title:String, content:String){
        ...
        val action: Notification.Action = Notification.Action.Builder(android.R.drawable.ic_dialog_info,"Open", pendingIntent).build()
